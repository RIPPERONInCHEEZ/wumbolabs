...
The archive above contains published records. This secondary snapshot tracks active local-model work; it is not a leaderboard, schedule, or claim that queued models have been tested.

<details class="archive-disclosure">
<summary>Tested / blocked snapshot</summary>

<p class="table-scroll-hint">Scroll horizontally to read all columns.</p>
<div class="labs-table-wrap" role="region" aria-label="Tested and blocked experiments" tabindex="0">
