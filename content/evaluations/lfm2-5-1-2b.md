...
- **Recommended profile:** llama.cpp QAD Q4_0 (`lfm2.5-1.2b-llamacpp-qad-q4-0`, current) — [canonical evidence](https://github.com/WumboLabs/eval-lfm2.5-1.2b)
...
Canonical profile repository: <https://github.com/WumboLabs/eval-lfm2.5-1.2b>
...
[Canonical evidence for this event](https://github.com/WumboLabs/eval-lfm2.5-1.2b)
...
- **llama.cpp QAD Q4_0** (`lfm2.5-1.2b-llamacpp-qad-q4-0`): <https://github.com/WumboLabs/eval-lfm2.5-1.2b>
