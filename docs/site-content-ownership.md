...
| Lab Records | Long-form reports, experiments, fit tests, baselines, and technical findings | `content/records/*.md`; preserve historical context and routes. Link model-specific records from their canonical Evaluation page. |
